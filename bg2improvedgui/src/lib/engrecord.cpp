...
void (CScreenRecord::*CScreenRecord_UpdateStyleBonus)(CUITextArea&, uint, int) =
...
void CScreenRecord::UpdateStyleBonus(CUITextArea& TextArea, uint ActiveWeaponStyle, int nLevel) { return (this->*CScreenRecord_UpdateStyleBonus)(TextArea, ActiveWeaponStyle, nLevel); }