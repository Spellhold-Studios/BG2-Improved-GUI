...
public:
    ...
    void SetGameWorldWindowSize(int left, int top, int right, int bottom, int argX);
    void CopyChatEditBox(CPanel& src, CPanel& dst);
    void OnLButtonUp(POINT pt);
    BOOL TogglePauseGame(bool bVisualPause, BOOL bSendMessage, int idPlayerPause);
	...
	int u118e;
	int u1192;
	long nBattleCryTimeOut; //1196h
	IECPtrList deathSoundList; //119h AB5884, 12h objects (int, Enum, unsigned short, int, int)
	int u11b6;
	char u11ba;
	char u11bb;
	char u11bc;
	...
	int u1238;
	int u123c;
	int TabPressedCountDownTime;  //1240h
	int u1244;
	int u1248;
};
