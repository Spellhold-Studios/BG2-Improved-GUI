...
BOOL (CUIButton::*CUIButton_NeedRedraw)() =
    SetFP(static_cast<BOOL (CUIButton::*)()>            (&CUIButton::NeedRedraw),      0x586B27);
...
BOOL CUIButton::NeedRedraw()                { return (this->*CUIButton_NeedRedraw)(); }
